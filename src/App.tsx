      ...
      <header className={`sticky top-0 z-10 backdrop-blur-lg border-b transition-all duration-300 ${
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            {/* Barra de búsqueda dentro del navbar */}
            <div className="flex items-center space-x-3">
              <SearchBar
                value={searchTerm}
            ...
            <div className="flex items-center space-x-3">
              <button
                onClick={resetQuiz}
                className={`inline-flex items-center px-4 py-2 backdrop-blur-sm border rounded-xl transition-all duration-300 hover:scale-105 active:scale-95 ${
                  isDark 
